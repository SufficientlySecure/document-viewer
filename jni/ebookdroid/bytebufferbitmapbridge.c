...
JNIEXPORT void JNICALL
Java_org_ebookdroid_common_bitmaps_ByteBufferBitmap_nativeEraseColor(JNIEnv* env, jclass classObject,
		jobject srcBuffer, jint width, jint height, jint c) {
	int i;
...
JNIEXPORT void JNICALL
Java_org_ebookdroid_common_bitmaps_ByteBufferBitmap_nativeAutoLevels(JNIEnv* env, jclass classObject,
...
Java_org_ebookdroid_common_bitmaps_ByteBufferBitmap_nativeFillRect(JNIEnv* env, jclass classObject, jobject srcBuffer,
		jint srcWidth, jobject dstBuffer, jint dstWidth, jint sub_x, jint sub_y, jint width, jint height) {
	uint8_t* src;
	uint8_t* dst;
	int y;
